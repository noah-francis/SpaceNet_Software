function likelihood = DuffPFMeasurementLikelihoodFcn(particles,measurement)
...
predictedMeasurement = particles(1,:) + 0.1  * randn(1,size(particles,2));
...
mu = 0; % mean
sigma = 0.1^2 * eye(numberOfMeasurements); % variance
